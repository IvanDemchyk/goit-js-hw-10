...
function createCountrieCard(country) {
  ...
  const readyCard = `<div class="country-card">
        <div class="country-card__header">
            ...
            <p class="country-card__field">Capital: <span class="country-value">${
              c.capital
            }</span></p>
            <p class="country-card__field">Population: <span class="country-value">${
              c.population
            }</span></p>
            <p class="country-card__field">Languages: <span class="country-value">${Object.values(
              c.languages
            ).join(',')}</span></p>
    </div>`;
    ...
    .map(
      c =>
        `<li class="country-list__item">
            ...
            <span class="country-list__name">${c.name.official}</span>
        </li>`
    )
    .join('');
